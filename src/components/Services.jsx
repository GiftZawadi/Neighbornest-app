      ...
      <div className='services-grid'>
        <div className='service'>
          ...
          <div className='service-text-container'>
            ...
            <span className='service-description'>
              ...
              cover every aspect of your learning journey.
            </span>
          </div>
        </div>
        <div className='service-1'>
          ...
          <div className='service-text-container-6'>
            ...
            <span className='service-description-8'>
              ...
              optimal results and safe progress.
            </span>
          </div>
        </div>
        <div className='service-9'>
          ...
          <div className='service-text-container-e'>
            ...
            Empowering neighbors to come together, create lasting memories, and stay informed about the latest local happenings through shared events and news.
            </span>
          </div>
        </div>
      </div>
